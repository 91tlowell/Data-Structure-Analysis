...
/*
    This is the Test/Performance for the BST implementation of inserting and searching.
...
/*========================================= inserting Test data entries into BST===================================================*/
    while(z < 40001){
        high_resolution_clock::time_point start = high_resolution_clock::now();

        for(int i = z - 100; i < z; i++){
            treeObj.addNode(arrayOfData[i]);
        }
        std::cout << "Value of x: " << *zPtr << std::endl;
...
/*========================================= Searching Test data entries in BST===================================================*/
        ...
        for(int i = 0; i < 100; i++){
            treeObj.searchNode(valueToSearchFor[i]);
        }
