...
/*
    This is the Test/Performance for the Hash Table implementation with linear probing collision resulution.
...
/*==================================Inserting Test data entries into Hash Table via Linear Probing===================================================*/
    while(z < 40001){
        high_resolution_clock::time_point start = high_resolution_clock::now();

        for(int i = z - 100; i < z; i++){
            HLP.insert(arrayOfData[i]);
        }
        ...
        numCollisions[j] = HLP.getNumCollisions();  // num of collisions

/*=========================================Searching Test data Hash Table via Linear Probing=========================================================*/
